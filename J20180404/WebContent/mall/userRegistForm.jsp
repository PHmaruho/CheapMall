...
#registbtn1,#registbtn2,#registbtn3 {
	position : relative;
	left : 30%;
	margin-top : 10px;
	border-style: solid;
...
#registbtn1:hover,#registbtn2:hover,#registbtn3:hover {
	border-width: 2px;
	padding: 5px 11px;
}
</style>
...
<body>
	<div class="container">
		<form action="UserRegistPro.mall" name="frm" onsubmit="return chk()">
			...
			<div class="h3">
				<h3>
					기본 정보(<span style="color: orange">◎</span>)필수 입력사항
				</h3>
			</div>
			<table class="registtb">
				<colgroup>
					<col style="background: #EDCE7A">
				</colgroup>
				<tr>
					<th><span>◎</span>아이디</th>
					<td><input type="text" name="id" placeholder="ID를 입력하세요"
						autofocus required="required" onkeyup=""> <input
						type="button" onclick="winop()" style="background-color: #EDCE7A"
						value="아이디 중복확인">
						<div id="idChk"></div>(영,&nbsp;소문자/숫자,&nbsp;4~16자)</td>
				</tr>
				<tr>
					<th><span>◎</span>비밀번호</th>
					<td><input type="password" name="pw" placeholder="비번을 입력하세요"
						maxlength="20" required="required">(영문&nbsp;대소문자/숫자&nbsp;4~20자)</td>

				</tr>
				<tr>
					<th><span>◎</span>비밀번호 확인</th>
					<td><input type="password" name="pw2" placeholder="비번을 재입력하세요"
				...
				<tr>
					...
					<td><input type="text" name="addtext1" id="zipcode"
						readonly="readonly" onclick="findZipcode()"> <input
						type="button" onclick="findZipcode()"
						style="background-color: #EDCE7A" value="우편번호검색"><br>
				...
				<tr>
					...
					</select> - <input type="tel" name="tel2" required="required"
						pattern="\d{3,4}"> - <input type="tel" name="tel3"
						required="required" pattern="\d{4}"></td>
				</tr>
				<tr>
					<th><span>◎</span>이메일</th>
				...
				<tr>
					...
					<td><input type="text" name="birth" id="birth"
						onclick="datePic()" required="required"></td>
				</tr>
				<tr>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;성별</th>
					<td><input type="radio" name="gender" id="M" checked="checked"
						value="M" class="inputText"> 남자 <input type="radio"
						name="gender" id="F" value="F" class="inputText"> 여자</td>
				</tr>
			</table>
			<input type="submit" value="회원가입" class="btn btn-success" id="registbtn1"> 
			<input type="reset" value="초기화" class="btn btn-primary" id="registbtn2"> 
			<input type="button" value="가입취소" onclick="" class="btn btn-danger" id="registbtn3">
		</form>
	</div>
</body>
</html>